...
public class PracticeHeroku2Page {
    public PracticeHeroku2Page(){
    ...
    public WebElement dropdown;                  //dropdownu web element olarak aldık tek değer var optionlar iiçerisinde

    @FindBy (xpath = "//input[@value='submit']")
    public WebElement submitButton;

    @FindBy (xpath = "//*[.='text.txt.txt']")
